...
DEFAULT_BENCHMARK_OUTPUT = SHARED_ROOT / "outputs" / "analysis" / "benchmark"
...
def main() -> None:
    ...
    table_path = benchmark_output / "tables" / "14_full_model_benchmark_summary.csv"
    out_dir = benchmark_output / "figures"
