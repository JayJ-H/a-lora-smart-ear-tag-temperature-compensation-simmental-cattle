...
DEFAULT_INPUT = ROOT / "data" / "processed" / "th_shrc_oof_predictions.csv"
DEFAULT_REFERENCE = ROOT / "data" / "processed" / "model_benchmark_oof_predictions.csv"
DEFAULT_CHOICES = ROOT / "outputs" / "analysis" / "benchmark" / "tables" / "14_evolutionary_search_choices.csv"
DEFAULT_OUTPUT = ROOT / "outputs" / "analysis" / "benchmark_replay"
