...
DEFAULT_REFERENCE = SHARED_ROOT / "data" / "processed" / "model_benchmark_metrics.csv"
DEFAULT_OUTPUT_DIR = SHARED_ROOT / "outputs" / "analysis" / "benchmark"
...
def run(args: argparse.Namespace) -> dict[str, object]:
    ...
    write_markdown(
        ...
        len(evolution_specs),
        Path("data/processed/th_shrc_oof_predictions.csv"),
        elapsed_all,
    )
