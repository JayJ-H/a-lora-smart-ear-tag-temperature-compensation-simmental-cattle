...
MODULE_DIR <- file.path(SHARED_ROOT, "分析", "TH-SHRC", "上游模块")
PUBLIC_INPUT <- file.path(SHARED_ROOT, "数据", "处理数据", "paired_temperature_records.csv")
OOF_INPUT <- file.path(SHARED_ROOT, "数据", "处理数据", "th_shrc_oof_predictions.csv")
FROZEN_SHAP_INPUT <- file.path(SHARED_ROOT, "数据", "处理数据", "th_shrc_shap_values.csv")
SHAP_STACK_INPUT <- file.path(SHARED_ROOT, "数据", "处理数据", "th_shrc_conditional_shap_stack_choices.csv")
ARGS <- parse_args()
...
CHUNK_DIR <- file.path(OUTPUT_DIR, "分块", RUN_LABEL)
