...
def main() -> int:
    ...
    commands = [
        (
            "scientific_results",
            [sys.executable, '脚本/verify_scientific_results.py', "--stage", "full"],
        ),
        (
            "repository",
            [sys.executable, '脚本/verify_repository.py', "--root", "."],
        ),
        ("system_tests", [sys.executable, '系统测试/run_system_tests.py']),
        ("repository_integrity", [sys.executable, '工具/check_repository_integrity.py']),
    ]
    results = []
