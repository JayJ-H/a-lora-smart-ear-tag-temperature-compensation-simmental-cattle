...
REPRODUCTION_SCRIPT = SHARED_ROOT / "analysis" / "th_shrc" / "reproduce_stack.py"


def verify_docs(output_dir: Path) -> dict[str, object]:
    required = [
        SHARED_ROOT / "analysis" / "th_shrc" / "README.md",
        SHARED_ROOT / "data" / "README.md",
...
def main() -> int:
    ...
    if args.verify_docs:
        try:
            ...
            return 1
        print(json.dumps({"documentation": result}, ensure_ascii=False, indent=2))
    return 0
