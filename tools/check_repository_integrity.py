...
REQUIRED = ['README.md', 'REPRODUCE.md', 'LICENSE_NOTICE.md', 'data/processed/th_shrc_oof_predictions.csv', 'data/processed/th_shrc_ablation_oof_predictions.csv', 'data/quality_controlled_anonymized/lora_packet_level_quality_controlled.csv', 'analysis/figures/plot_fig15_17_public.py', 'firmware/ear_tag/main/main.cpp', 'firmware/gateway/main/main.cpp', 'hardware/ear_tag/pcb/ear_tag_easyeda_project.epro2', 'hardware/gateway/pcb/gateway_easyeda_project.epro2', 'backend/reference/schema.sql']
