...
kpi_metrics (
  ...
  description         TEXT,
  category            ENUM('production', 'reproduction', 'health', 'economic', 'efficiency'),
  unit                VARCHAR(30),
...
kpi_dashboards (
  ...
  name                VARCHAR(200) NOT NULL,
  description         TEXT,
  category            ENUM('overview', 'production', 'reproduction', 'health', 'economic'),
...
predictive_models (
  ...
  name                VARCHAR(200) NOT NULL,
  description         TEXT,
  type                ENUM('production', 'health', 'economic', 'reproduction'),
...
workflow_templates (
  ...
  name                VARCHAR(200) NOT NULL,
  description         TEXT,
  category            ENUM('health', 'reproduction', 'production', 'maintenance'),
