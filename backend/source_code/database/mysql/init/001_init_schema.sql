...
CREATE DATABASE IF NOT EXISTS cattle_management
...
CREATE TABLE IF NOT EXISTS omics_samples (
  ...
  integrity_score DECIMAL(6,2) NULL,
  ...
  KEY idx_omics_samples_sample_type (sample_type),
  KEY idx_omics_samples_status (status),
  KEY idx_omics_samples_collection_date (collection_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS omics_datasets (
  ...
  KEY idx_omics_datasets_data_type (data_type),
...
CREATE TABLE IF NOT EXISTS omics_markers (
  ...
  maf DECIMAL(8,5) NULL,
  p_value DECIMAL(18,10) NULL,
  effect_size DECIMAL(14,6) NULL,
  evidence_level VARCHAR(32) NULL,
  payload JSON NULL,
  created_at DATETIME(3) NULL,
  updated_at DATETIME(3) NULL,
  UNIQUE KEY uk_omics_markers_dataset_marker (dataset_id, marker_code),
  KEY idx_omics_markers_dataset_id (dataset_id),
  KEY idx_omics_markers_marker_type (marker_type),
  KEY idx_omics_markers_trait (trait),
  KEY idx_omics_markers_gene_symbol (gene_symbol)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS multi_omics_associations (
  ...
  visualization_type VARCHAR(32) NULL,
  conclusion TEXT NULL,
  payload JSON NULL,
  created_at DATETIME(3) NULL,
  updated_at DATETIME(3) NULL,
  KEY idx_multi_omics_trait (trait),
  KEY idx_multi_omics_primary_dataset_id (primary_dataset_id),
  KEY idx_multi_omics_secondary_dataset_id (secondary_dataset_id),
  KEY idx_multi_omics_association_type (association_type)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS breeding_analyses (
  ...
  heritability DECIMAL(8,4) NULL,
  reliability DECIMAL(8,4) NULL,
  predicted_gain DECIMAL(14,4) NULL,
  ...
  created_at DATETIME(3) NULL,
  updated_at DATETIME(3) NULL,
  UNIQUE KEY uk_breeding_analyses_analysis_code (analysis_code),
  KEY idx_breeding_analyses_target_trait (target_trait),
  KEY idx_breeding_analyses_model_type (model_type),
  KEY idx_breeding_analyses_status (status),
  KEY idx_breeding_analyses_executed_at (executed_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
