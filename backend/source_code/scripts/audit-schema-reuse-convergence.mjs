...
const SOURCE_ROOTS = ['src', 'scripts', 'database', 'docs']
...
function scanForbiddenUserFacingFieldTerms() {
  ...
  const allowedFiles = new Set([
    'scripts/audit-schema-reuse-convergence.mjs',
    'scripts/audit-shift-milk-import-package-semantics.mjs'
  ])
