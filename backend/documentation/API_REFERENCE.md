...
The full generic RPC method surface is large and table-driven. Refer to the sanitized backend source and the database frontend/backend contract for exact request payloads. No passwords, database accounts, tokens, remote hosts, or private keys are included in this package.
