        ...
        await connection.query(
          `
            INSERT INTO hardware_devices (
              ...
              'seed-device-readiness-gateway', 'Seed Device Readiness Gateway', '网关', 'online',
          ...
          [
            ...
            JSON.stringify({ source: '脚本/repair-database-bug-closure-blockers.mjs', nonDestructiveRepair: true }),
            now,
