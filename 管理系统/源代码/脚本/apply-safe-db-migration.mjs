...
dotenv.config({
  path: path.join(projectRoot, '运维/生产配置/.env.prod'),
  override: true,
  quiet: true
})
...
const DEFAULT_MIGRATIONS = [
  '数据库/mysql/migrations/031_schema_version_metadata.sql',
  '数据库/mysql/migrations/032_fix_collation_and_compat_columns.sql',
  '数据库/mysql/migrations/033_restrict_cattle_breed_scope.sql'
]
