...
const backend = fs.readFileSync(path.join(projectRoot, '脚本/mysql-backend-server.mjs'), 'utf8')
const dashboard = fs.readFileSync(
  path.join(projectRoot, 'src/views/dashboard/board/index.vue'),
  'utf8'
)
const nginx = fs.readFileSync(path.join(projectRoot, '运维/生产配置/nginx.conf'), 'utf8')
