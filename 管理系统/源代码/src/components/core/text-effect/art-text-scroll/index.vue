...
<script setup lang="ts">
  ...
  const themeClasses = computed(() => {
    const themeMap: Record<ThemeType, string> = {
      theme: 'text-theme text-opacity-90 !border-theme border-opacity-50',
      primary: 'text-primary text-opacity-90 !border-primary border-opacity-50',
      secondary: 'text-secondary text-opacity-90 !border-secondary border-opacity-50',
      error: 'text-error text-opacity-90 !border-error border-opacity-50',
      info: 'text-info text-opacity-90 !border-info border-opacity-50',
      success: 'text-success text-opacity-90 !border-success border-opacity-50',
      warning: 'text-warning text-opacity-90 !border-warning border-opacity-50',
      danger: 'text-danger text-opacity-90 !border-danger border-opacity-50'
    }
