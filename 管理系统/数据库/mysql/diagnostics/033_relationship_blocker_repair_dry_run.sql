...
SELECT
  ...
  'Run 脚本/repair-data-relationship-blockers.mjs --dry-run first; only run generated relationship-repair-authorized.sql after backup and main-controller approval.' AS instruction;
