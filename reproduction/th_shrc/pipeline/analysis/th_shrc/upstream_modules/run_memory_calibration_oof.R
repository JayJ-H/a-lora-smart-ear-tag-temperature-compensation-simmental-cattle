...
OUT_CHECK <- file.path(OUTPUT_DIR, "memory_calibration_oof_check.csv")
...
main <- function() {
  ...
  df_source <- source_env$build_demo_analysis_dataset()
  ...
  fold_source <- locked_or_generated_outer_folds(df_source, seed = fold_seed)
